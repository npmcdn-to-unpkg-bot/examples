...
public abstract class IdNamePairControllerBase<T extends IdNamePair> {
	static final String messageName = "message";
	...
	@RequestMapping(value="list", method=RequestMethod.GET, produces={"text/html", "application/xml", "application/json"})
